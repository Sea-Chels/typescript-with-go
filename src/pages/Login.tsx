    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative max-w-md w-full space-y-8 p-8 bg-dark-surface/30 backdrop-blur-xl rounded-2xl border border-dark-border/50 shadow-2xl animate-slide-up">
        ...
        <div className="relative">
          {/* Logo or icon */}
          <div className="mx-auto w-20 h-20 bg-gradient-to-br from-accent-primary to-neon-purple rounded-2xl flex items-center justify-center shadow-lg shadow-accent-primary/25 animate-glow">
